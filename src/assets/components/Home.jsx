...
{/* FOOTER SECTION */}
<footer className="bg-[#0a0a0a] text-white pt-16 pb-8 px-4 border-t border-zinc-800">
  <div className="max-w-7xl mx-auto">
    
    {/* Top Row: Logo, Navigation, and Socials */}
    <div className="flex flex-col lg:flex-row justify-between items-center gap-10 mb-12">
      
      {/* Logo Area */}
      <div className="flex items-center space-x-2">
        <div className="bg-[#c1ff00] p-2 rounded-lg">
          {/* Using your cube logo placeholder */}
          <img src="/vite.png" alt="SquareUp Logo" className="w-6 h-6" />
        </div>
        <span className="text-2xl font-bold tracking-tight">SquareUp</span>
      </div>

      {/* Navigation Links */}
      <nav className="flex flex-wrap justify-center gap-6 text-zinc-300">
        <a href="#" className="hover:text-[#c1ff00] transition">Home</a>
        <a href="#" className="hover:text-[#c1ff00] transition">Services</a>
        <a href="#" className="hover:text-[#c1ff00] transition">Work</a>
        <a href="#" className="hover:text-[#c1ff00] transition">Process</a>
        <a href="#" className="hover:text-[#c1ff00] transition">About</a>
        <a href="#" className="hover:text-[#c1ff00] transition">Careers</a>
        <a href="#" className="hover:text-[#c1ff00] transition">Contact</a>
      </nav>

      {/* Social Media Box */}
      <div className="flex items-center space-x-4 bg-[#111111] border border-zinc-800 p-4 rounded-xl">
        <span className="text-zinc-400 mr-2">Stay Connected</span>
        <div className="flex space-x-3">
          {/* Replace # with your social links */}
          <a href="#" className="bg-zinc-800 p-2 rounded-lg hover:bg-[#c1ff00] hover:text-black transition text-[#c1ff00]">
